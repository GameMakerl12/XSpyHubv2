...
local function WTUKXJU_fake_script() -- ExecuteBTN.LocalScript 
...
coroutine.wrap(WTUKXJU_fake_script)()
local function GMIOAGK_fake_script() -- ClearBTN.LocalScript 
...
coroutine.wrap(GMIOAGK_fake_script)()
local function FYZHVSF_fake_script() -- ScriptHubBTN.LocalScript 
...
coroutine.wrap(FYZHVSF_fake_script)()
local function HIZIW_fake_script() -- ExecutorBox.LocalScript 
...
coroutine.wrap(HIZIW_fake_script)()
local function OTRPCID_fake_script() -- ExecuteFrame.DRAGGABLE GUI!!!!! 
...
coroutine.wrap(OTRPCID_fake_script)()
local function IMHUA_fake_script() -- InfYield.LocalScript 
...
coroutine.wrap(IMHUA_fake_script)()
local function QEZSLW_fake_script() -- ExecuteBTN_2.LocalScript 
...
coroutine.wrap(QEZSLW_fake_script)()
local function MOUCLN_fake_script() -- CloseBTN.LocalScript 
...
coroutine.wrap(MOUCLN_fake_script)()
local function HEVIBBL_fake_script() -- ScriptHubFrame.DRAGGABLE GUI!!!!! 
...
coroutine.wrap(HEVIBBL_fake_script)()
